...
<body>
    ...
    <div class="container-fluid login-background d-flex align-items-center justify-content-center" style="background-image: url('../../img/login/students-login-bg.png');">
        <div class="row login-card-wrapper">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center">
                <div class="card login-card p-4">
                    <h4 class="card-title mb-2">Iniciar Sesión - Estudiantes</h4>
                    <p class="card-subtitle mb-3 text-muted">Administracion de procesos de admision</p>
                    <form id="loginForm" data-login-key="STUDENTS">
                        <div class="mb-4">
